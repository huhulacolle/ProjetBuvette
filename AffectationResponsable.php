...
<form action="AffectationResponsableExe.php" method="post">
<center> Nouveau Responsable </center>
<br> <br>
...
$result = $sth->fetchAll(PDO::FETCH_ASSOC);  
foreach ($result as $row){ 
echo '<option value="'.$row['idM'].'">'; echo $row['eqA']; echo ' vs '; echo $row['eqB'];  echo '</option>';
  }
?>
</div>
</td>
