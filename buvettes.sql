...
--
-- Contenu de la table EstOuverte
--
...
--
-- Contrainte de clé étrangère pour la table Buvette
--
ALTER TABLE Buvette
  ADD CONSTRAINT fk_buvette_responsable FOREIGN KEY (responsable) REFERENCES Volontaire(idV);

--
-- Contraintes de clé étrangère pour la table EstOuverte
--
ALTER TABLE EstOuverte
...
--
-- Contraintes de clé étrangère pour la table EstPresent
--
ALTER TABLE EstPresent
...
--
-- Contraintes de clé étrangère pour la table Match
--
ALTER TABLE Matchs
