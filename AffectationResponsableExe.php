...
if ($result == null) {
    ...
    <ul class="nav">
        <li class="nav-item">
            <a class="nav-link active" href="AffectationResponsable.php">Retour</a>
        </li>
    </ul>
    <br>
    <center>
        <h4> Erreur : La buvette et le match choisis ne concorde pas ensemble </h4>
    </center>
    <?php
} else {
    ...
    <br> <br> <br>
    <center>
        <h2> L'affectation s'est effectuée </h2>
