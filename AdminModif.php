...
include_once 'Connect.php';
    ...
    foreach ($result as $row) {
        ...
        echo '</td>';
        echo '<td>';
        echo '<input type="text" name="nomV" value = "' . $row['nomV'] . '">';echo '</td>';
        echo '<td>';
...
include_once 'Connect.php';
    ...
    foreach ($result as $row) {
        ...
        echo '</td>';
        echo '<td>';
        echo '<input type="date" name="dateM" value = "' . $row['dateM'] . '">';echo '</td>';
        echo '<td>';
        echo '<input type="text" name="eqA" value = "' . $row['eqA'] . '">';echo '</td>';
        echo '<td>';
        echo '<input type="text" name="eqB" value = "' . $row['eqB'] . '">';
        echo '</td>';
        echo '<td>';
        echo '<input type="text" name="scoreA" value = "' . $row['scoreA'] . '">';echo '</td>';
        echo '<td>';
...
include_once 'Connect.php';
    ...
    foreach ($result as $row) {
        ...
        echo '</td>';
        echo '<td>';
        echo '<input type="text" name="nomB" value = "' . $row['nomB'] . '">';echo '</td>';
        echo '<td>';
        echo '<input type="text" name="emplacement" value = "' . $row['emplacement'] . '">';echo '</td>';
        echo '<td>';
        echo '<input type="text" name="responsable" value = "' . $row['responsable'] . '">';
        echo '</td>';
    }
